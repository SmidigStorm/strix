...
public class MutationResolver {
    ...
    public Opptak opprettOpptak(@Argument OpprettOpptakInput input) {
        ...
        opptak.setMaxUtdanningerPerSoknad(input.getMaxUtdanningerPerSoknad() != null ? 
                                         input.getMaxUtdanningerPerSoknad() : 10);
    ...
    public static class OpprettOpptakInput {
        ...
        public java.time.LocalDate getSoknadsfrist() { return soknadsfrist; }
        public void setSoknadsfrist(java.time.LocalDate soknadsfrist) { this.soknadsfrist = soknadsfrist; }
        
        public java.time.LocalDate getSvarfrist() { return svarfrist; }
        public void setSvarfrist(java.time.LocalDate svarfrist) { this.svarfrist = svarfrist; }
