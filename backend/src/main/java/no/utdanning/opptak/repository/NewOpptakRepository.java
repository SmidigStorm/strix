...
public interface NewOpptakRepository {
   ...
   */
  List<Opptak> findWithFilters(String navn, Integer aar, OpptaksType type, OpptaksStatus status, 
   ...
   */
  long countWithFilters(String navn, Integer aar, OpptaksType type, OpptaksStatus status, 
