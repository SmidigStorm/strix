...
public class OpptakRepository {
    ...
    public Opptak saveOpptak(Opptak opptak) {
        ...
        jdbcTemplate.update(sql, 
            opptak.getId(), opptak.getNavn(), opptak.getType().name(), opptak.getAar(),
            opptak.getSoknadsfrist(), opptak.getSvarfrist(), opptak.getMaxUtdanningerPerSoknad(),
            opptak.getStatus().name(), opptak.getOpptaksomgang(), opptak.getBeskrivelse(),
            opptak.getOpprettet(), opptak.getAktiv());
